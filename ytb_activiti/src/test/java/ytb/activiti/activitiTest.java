...
public class activitiTest extends ITestImpl {
	String url = "http://localhost/rest/activiti";
	...
	@JTest
	@JTestClass.title("启动工作流实例")
	@JTestClass.pre("")
	@JTestClass.step("post http://localhost:8080/rest/activiti")
	@JTestClass.exp("ok")
	public void test0002_rest_mngr() {
		...
		req.seqno = System.currentTimeMillis();
		req.cmdtype = "manager";
		req.cmd = "getActivitiTemplateList";
		req.msgBody = JSONObject.parseObject("{}");
