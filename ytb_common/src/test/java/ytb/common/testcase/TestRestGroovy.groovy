...
//        req.setApiKey(apiKey);
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1/rest/test")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:8080/rest/context")
    @JTestClass.exp("ok")
...
//{"msgBody":{"config_item":"SUCCESS"},"token":"6994e243180441888535ff1f62495510","cmdtype":"config","cmd":"getConfig","reqtime":1534043004468,"seqno":1534043004468} '''
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/context")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1/rest/context/getPicCode")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/context/picCode")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/ytbsuser")
    @JTestClass.exp("ok")
    ...
    public void test0020_getAreaByIP() {
        ...
        //String b=YtbContext.getYtb_context().getAreaByIP("127.0.0.1");
    ...
    @JTestClass.title("获取图形码")
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/context/getPicCode")
    @JTestClass.exp("ok")
    ...
    public void test_0024_getLoginSSO() {
        ...
        req.cmdtype = "context";
        req.cmd = "getLogSso";
        String url_context="http://127.0.0.1/rest/context";
