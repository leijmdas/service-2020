...
//    MongoClient mongoClient = new MongoClient("192.168.4.162", 27017);
...
//        String url = "jdbc:mongo://192.168.4.162:27017/project";
//        Connection con = DriverManager.getConnection(url, "admin", "123456");
