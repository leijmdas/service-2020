...
public class TestUserPerson extends ITestImpl {
	String url_base = "http://127.0.0.1/rest/ytbuser";
	String url_base1 = "http://127.0.0.1/rest/context";
	...
	@JTestClass.pre("")
	@JTestClass.step("post http://127.0.0.1:8080/rest/ytbuser")
	@JTestClass.exp("ok")
	public void test0002_userLogin() {
		...
		String ret = httpclient.post("http://127.0.0.1/rest/ytbuser",req.toJSONString(), "application/json");
		httpclient.checkStatusCode(200);
		MsgResponse resp=MsgResponse.parseResponse(ret);
		checkEQ(0,resp.getRetcode());
	...
	@JTestClass.pre("")
	@JTestClass.step("post http://127.0.0.1/rest/ytbuser")
	@JTestClass.exp("ok")
