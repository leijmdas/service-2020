...
public class TestTemplateManager extends ITestImpl {
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/template/previewImage")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/template/document/upload")
    @JTestClass.exp("ok")
  ...
  @JTest
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1/rest/template")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/project/document")
    @JTestClass.exp("ok")
