...
public class TestSysUser extends ITestImpl {
	...
	String url_base="http://127.0.0.1/rest/sysuser";
...
//	HttpClientNode httpclient;
	...
	public void test_0002_addUser() {
		...
		req.cmdtype = "context";
		req.cmd = "getLogSso";
		String url1 ="http://127.0.0.1/rest/query/1";

		//String ret1 = httpclient.post(url, req.toJSONString(), "application/json");
		String ret1 = httpclient.get( url1 );
		String url  ="http://127.0.0.1/rest/qp?a=1&b=2";
...
//		checkEQ(0,json.getInteger("retcode"));
	...
	@JTestClass.pre("")
	@JTestClass.step("post http://193.112.182.218:80/rest/sysuser")
	@JTestClass.exp("ok")
	...
	@JTestClass.title("查询菜单列表")
	@JTestClass.pre("")
	@JTestClass.step("post http://127.0.0.1:80/rest/sysuser")
	@JTestClass.exp("ok")
