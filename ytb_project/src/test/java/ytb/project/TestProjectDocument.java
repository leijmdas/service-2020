...
public class TestProjectDocument extends ITestImpl {
    ...
    String url_base = "http://127.0.0.1/rest/project/template";

    String url_image = "http://127.0.0.1/rest/project/image";
    String url_upload = "http://127.0.0.1/rest/project/upload";
    String url_projectCenter = "http://127.0.0.1/rest/projectCenter";
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/project/template")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/project/image")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/project/download")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1/rest/tagTableService/manager")
    @JTestClass.exp("ok")
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:80/rest/template/template/upload")
    @JTestClass.exp("ok")
