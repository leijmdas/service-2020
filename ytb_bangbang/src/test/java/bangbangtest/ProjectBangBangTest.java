...
public class ProjectBangBangTest extends ITestImpl {
    ...
    private String url_manager = "http://127.0.0.1:80/projectBangBangRest/bangBangRestAjax";
    ...
    @JTestClass.pre("xxx")
    @JTestClass.step("post http://127.0.0.1:80/projectBangBangRest/bangBangRestAjax")
    @JTestClass.exp("ok")
