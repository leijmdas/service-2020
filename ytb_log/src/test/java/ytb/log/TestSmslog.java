...
public class TestSmslog extends ITestImpl {
	...
	public void setUp() {
		...
		///{"token":"b2d9c43d-14c8-43fa-8c78-3c57e64d9d6a","reqtime":1534035651475,"seqno":1534035651475,"cmdtype":"projectType","cmd":"getProjectTypeList","msgBody":{"x":1}}
	}
	...
	public void test0002_rest_mngr() {
		...
		data=new Gson().toJson(req).toString();
		String ret = httpclient.post("http://localhost:8080/rest/smsLog_sms", data, "application/json");
		httpclient.checkStatusCode(200);
		JSONObject json=JSONObject.parseObject(ret);
		checkEQ(0,json.getInteger("retcode"));
	...
	public void test0003_rest_mngr() {
		...
		req.msgBody = JSONObject.parseObject("{\"sms_code\":005980,\"phone\":18772103675}");
		data=new Gson().toJson(req).toString();
		String ret = httpclient.post("http://localhost/rest/smsLog_sms",data , "application/json");
		httpclient.checkStatusCode(200);
		JSONObject json=JSONObject.parseObject(ret);
		checkEQ(0,json.getInteger("retcode"));
		System.out.println(data);
	...
	@JTestClass.title("修改真值约束")
	@JTestClass.pre("")
	@JTestClass.step("post http://127.0.0.1:8080/rest/sysuser")
	@JTestClass.exp("ok")
	public void addUser() {
