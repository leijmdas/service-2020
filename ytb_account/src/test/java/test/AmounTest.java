...
public class AmounTest extends ITestImpl {
    String url_base = "http://127.0.0.1:8080/rest/ytbuser";
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:8080/rest/wallet")
    @JTestClass.exp("ok")
    public void test0001_accountIncrease() {
        ...
        String ret = httpclient.post("http://127.0.0.1:8080/rest/wallet", data, "application/json");
    ...
    @JTestClass.pre("")
    @JTestClass.step("post http://127.0.0.1:8080/rest/weChatNotify")
    @JTestClass.exp("ok")
    public void test0002_weChatNotify() {
        data = new Gson().toJson("{\"outTradeNo\": \"26\", \"totalFee\": \"98599\" }").toString();

        String ret = httpclient.post("http://127.0.0.1:8080/rest/weChatNotify", data, "application/json");
        httpclient.checkStatusCode(200);
        JSONObject json = JSONObject.parseObject(ret);
        checkEQ(0, json.getInteger("retcode"));
        System.out.println(data);
